...
namespace Pulumi.LambdaBuilders
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.LambdaBuilders.version.txt");
    ...
    internal sealed class LambdaBuildersResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public LambdaBuildersResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
