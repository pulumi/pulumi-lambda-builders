...
def build_go(architecture: Optional[builtins.str] = None,
    ...
    :param builtins.str architecture: Lambda function architecture to build for. Valid values are `"x86_64"` and `"arm64"`. Default is `"x86_64"`.
    :param builtins.str code: The path to the go code to build
    """
    __args__ = dict()
...
def build_go_output(architecture: Optional[pulumi.Input[Optional[builtins.str]]] = None,
